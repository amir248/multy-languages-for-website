...
document.querySelector('input[type="checkbox"]').addEventListener('click',()=>{
  if(document.querySelector('input[type="checkbox"]').checked){
    ...
    document.querySelector('body > main:nth-child(1) > fieldset:nth-child(2) > label:nth-child(1) > span:nth-child(2)').innerHTML=`English`;
  }else{
